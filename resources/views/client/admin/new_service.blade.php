        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><b>@lang('Add New Service')</b></h3>
                </div>
                @if (count($errors) > 0)
                ...
                <div class="panel-body">
                    <form action="" method="post" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name="name" value="{{old('name')}}" placeholder="Enter Service Name" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">@lang('Description')<span class='text-danger'>*</span></label>
                            <div class="col-sm-6">
                                <input class="form-control" name="description" value="{{old('description')}}" placeholder="Enter Service Description" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">@lang('Price')<span class='text-danger'>*</span></label>
                            <div class="col-sm-6">
                                <input class="form-control" name="price" value="{{old('price')}}" placeholder="Price" type="number" step="0.01" min="1" required
                            </div>
                        </div>
