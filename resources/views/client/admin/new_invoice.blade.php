                ...
                <div class="panel-body">
                    <form style="border-radius: 0px;" method="post" action="" class="form-horizontal group-border-dashed">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" placeholder="Additional Notes for the Customer" name="note" maxlength="255"> </textarea>
                            </div>
                        </div>
...
@section('javascript')
    <script>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        try {
                            ...
                            newDoc = newDoc + '<div class="col-sm-3"><input class="form-control" name="item[]" value="'+item+'" placeholder="Enter Item Name" required '+readonly+'></div>';
                            newDoc = newDoc + '<div class="col-sm-3"><input class="form-control" name="desc[]" value="'+desc+'" placeholder="Enter Item Description" required></div>';
        ...
        function populate() {
            document.getElementById("cust_cont").innerHTML = document.getElementById("customer").selected
        }
