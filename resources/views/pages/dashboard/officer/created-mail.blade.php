        ...
        <tr>
            <td align="center" valign="top">
                ...
                <div class=" text-center">
                    ...
                    <p>@lang('Hello ') {{ $officer->first_name }},</p>

                    <p>@lang('Your account have just been set up on  ') {{ env('APP_NAME') }} | {{$client->name}},</p>

                    <p>@lang('Login on') <a href="http://{{$client->configuration->domain}}/admin">
                            http://{{$client->configuration->domain}}/admin</a> @lang('with the following credential') <br>
...
<table style="color:#fff" width="640" cellpadding="0" cellspacing="0" border="0" class="wrapper footer"
   bgcolor="#1c3061">
<tr>
